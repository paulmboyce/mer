...
// Render latest daily CO2 PPM
exports.ppm_daily = function(req, res) {
//    res.send('\n\nCONTROLLER SAYS: The latest daily CO2 PPM is:  ==>  ' +  dailyAvgCO2 + ' ppm \n\n'  );
    res.render('index', { title: 'The latest daily CO2 PPM is:  ' + dailyAvgCO2 });
